...
module.exports = {
  ...
  '263': {
    ...
    original: 'Partial Authorization Not Allowed',
    action: 'Fix',
  ...
  '534': {
    ...
    original: 'Do Not Honor   High Fraud',
    action: 'Cust',
  ...
  '570': {
    ...
    original: 'Stop payment order one time recurring',
    action: 'Fix',
  ...
  '571': {
    ...
    original: 'Revocation of Authorization',
    action: 'Cust',
  ...
  '572': {
    ...
    original: 'Revocation of All Authorizations',
    action: 'Cust',
  ...
  '755': {
    ...
    original: 'No Account/Unable to Locate',
    action: 'Cust',
