...
module.exports = {
  ...
  '247': {
    type: 'R',
    name: 'Check conversion Data Error', // Check Conversion Data Error
    action: 'Fix',
  ...
  '503': {
    type: 'D',
    name: 'Fraud/ Security Violation', // Fraud/Security Violation
    action: 'Cust',
    description: 'CID did not match Note: Discover only'
  },
  '505': {
    type: 'D',
    name: 'Negative File', // Negative file
    action: 'Cust',
  ...
  '524': {
    type: 'D',
    name: 'Altered Data', // Altered data
    action: 'Fix',
  ...
  '589': {
    type: 'D',
    name: 'CVD Value Failure', // CVD Value Failure Cust
    action: 'Cust',
  ...
  '760': {
    type: 'R/D', // Declined
    name: 'ACH Non-Participant', // ACH Non Participant
    action: 'Cust',
  ...
  '777': {
    type: 'D',
    name: 'Original transaction was not approved', // Original transaction not approved
    action: 'Cust',
